...
var holidayCmd = &cobra.Command{
	Use:   "holiday [next/last]",
	Short: "Get information about the next (or last) holiday",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		switch args[0] {
		case "next":
			dt, err = client.NextHoliday(context.Background())
		case "last":
			dt, err = client.PreviousHoliday(context.Background())
		}
		if err != nil {
